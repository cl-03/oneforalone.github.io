...
辞职前的我虽然说是月收入过万了，但是工作的内容相当枯燥，虽然是和阿里达摩院一起构建智慧城市，在这期间去过交管局、交警大队、市公安局、城管委。听起来很高大上，很厉害，其实也就是个普通的SA（System Administrator），偶尔部署系统、排查问题，日常就是检查系统各项数据是否正常、资源是否过载。一般来说基本上花个两三天就能将系统部署好，之后机械式的配置。干了三个月，感觉完全进步多少，反而是将 [The CommonLisp Cookbook][1] 给翻译了大半。然后有天在上班的时候，突然想起了《钢铁是怎样炼成的》里面保尔柯察金的一句话：
> 人的一生应该这样度过：当回首往事的时候，他不会因为虚度年华而悔恨，也不会因为碌碌无为而羞愧
